...
Sources += $(Directory)loader/Loader.cpp
Sources += $(Directory)loader/PlayerAttr.cpp
Sources += $(Directory)loader/BombAttr.cpp
Sources += $(Directory)terrain/Board.cpp
...
Sources += $(Directory)utils/StaticTools.cpp
